...
public class PostNewOrderPage {
    ...
    public void validateResponseBodyPostCreateNewOrder() {
        restAssuredThat(response -> response.body("data[0].User.ID",equalTo(18559)));
        ...
        restAssuredThat(response -> response.body("data[0].Product.ID",equalTo(13425)));
